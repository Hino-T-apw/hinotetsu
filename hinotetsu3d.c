...
//
// Build (MSVC):
//   cl /O2 hinotetsu3d.c hinotetsu3.c /I <libuv_include> /link <libuv_lib> ws2_32.lib iphlpapi.lib userenv.lib
//
// Run:
//   ./hinotetsu3d -p 11211 -m 256
//
// Architecture:
...
// Uncomment to enable latency profiling
// #define PROFILE_LATENCY 1
...
#define FLUSH_THRESHOLD (64 * 1024)  // Flush more frequently
#endif
